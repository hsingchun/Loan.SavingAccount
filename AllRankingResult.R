...
md1<-read.csv("a0+C50.csv",header = T)
md2<-read.csv("a0+RF.csv",header = T)
md3<-read.csv("a0+XGB.csv",header = T)
md4<-read.csv("aR+C50.csv",header = T)
md5<-read.csv("aR+RF.csv",header = T)
md6<-read.csv("aR+XGB.csv",header = T)
md7<-read.csv("aSMO+C50.csv",header = T)
md8<-read.csv("aSMO+RF.csv",header = T)
md9<-read.csv("aSMO+XGB.csv",header = T)

a<-as.integer(266684*0.05)
b<-as.integer(266684*0.10)
c<-as.integer(266684*0.15)
d<-as.integer(266684*0.20)
e<-as.integer(266684*0.25)
f<-as.integer(266684*0.30)
g<-as.integer(266684*0.35)
h<-as.integer(266684*0.40)
i<-as.integer(266684*0.45)
j<-as.integer(266684*0.50)
...
write.table(TopRankC,file = "aNtopRankC.csv",sep = ",")

########################################################################################

# -----Not Cont.-----
CntR<-function(data,top){
  xx <- top-(266684*0.05)+1
  ar <-arrange(data,desc(PredictProb))
  sub <- ar[(xx:top),]
  table(sub$TA_LOAN)
...
write.table(TopRank,file = "aNtopRank.csv",sep = ",")

# =======PLOTS =======
#TRC<-read.csv("aTopRankC.csv",header = T)
...
#TR<-read.csv("aTopRank.csv",header = T)
