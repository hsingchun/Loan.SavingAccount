...
md1<-read.csv("t0+C50.csv",header = T)
md2<-read.csv("t0+RF.csv",header = T)
md3<-read.csv("t0+XGB.csv",header = T)
md4<-read.csv("tR+C50.csv",header = T)
md5<-read.csv("tR+RF.csv",header = T)
md6<-read.csv("tR+XGB.csv",header = T)
md7<-read.csv("tSMO+C50.csv",header = T)
md8<-read.csv("tSMO+RF.csv",header = T)
md9<-read.csv("tSMO+XGB.csv",header = T)

a<-as.integer(53336*0.05)
b<-as.integer(53336*0.10)
c<-as.integer(53336*0.15)
d<-as.integer(53336*0.20)
e<-as.integer(53336*0.25)
f<-as.integer(53336*0.30)
g<-as.integer(53336*0.35)
h<-as.integer(53336*0.40)
i<-as.integer(53336*0.45)
j<-as.integer(53336*0.50)
...
write.table(TopRankC,file = "tNtopRankC.csv",sep = ",")
...
write.table(TopRank,file = "tNtopRank.csv",sep = ",")

# =======PLOTS =======
#TRC<-read.csv("tTopRankC.csv",header = T)
...
#TR<-read.csv("tTopRank.csv",header = T)
