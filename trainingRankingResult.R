...
md1<-read.csv("tr0+C50.csv",header = T)
md2<-read.csv("tr0+RF.csv",header = T)
md3<-read.csv("tr0+XGB.csv",header = T)
md4<-read.csv("trR+C50.csv",header = T)
md5<-read.csv("trR+RF.csv",header = T)
md6<-read.csv("trR+XGB.csv",header = T)
md7<-read.csv("trSMO+C50.csv",header = T)
md8<-read.csv("trSMO+RF.csv",header = T)
md9<-read.csv("trSMO+XGB.csv",header = T)

a<-as.integer(133342*0.05)
b<-as.integer(133342*0.10)
c<-as.integer(133342*0.15)
d<-as.integer(133342*0.20)
e<-as.integer(133342*0.25)
f<-as.integer(133342*0.30)
g<-as.integer(133342*0.35)
h<-as.integer(133342*0.40)
i<-as.integer(133342*0.45)
j<-as.integer(133342*0.50)
...
write.table(TopRankC,file = "trNtopRankC.csv",sep = ",")

########################################################################################

# -----Not Cont.-----
CntR<-function(data,top){
  xx <- top-(133342*0.05)+1
  ar <-arrange(data,desc(PredictProb))
  sub <- ar[(xx:top),]
  table(sub$TA_LOAN)
...
write.table(TopRank,file = "trNtopRank.csv",sep = ",")

# =======PLOTS =======
#TRC<-read.csv("trTopRankC.csv",header = T)
...
#TR<-read.csv("trTopRank.csv",header = T)
